...
class misc_helper {
    ...
    static function fpdf_multiline($data, $limit) {

        $arrJabatan = explode(" ", $data);
        $arrLineJabatan = array();
        ...
        return $arrLineJabatan;
    }

    static function fpdf_multiline_bypoint($fpdf, $data, $limit) {
        $arrJabatan = explode(" ", $data);
        $arrLineJabatan = array();

        ...
        <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Form Naik Pangkat</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                ...
                <div class="form-group">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<input name="tapt_date_start" class="form-control datepicker" id="tglLahir" data-date-format="yyyy-mm-dd" placeholder="Tanggal SK">
